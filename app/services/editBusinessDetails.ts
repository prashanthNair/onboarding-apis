  ...
  try {
    const params = {
      ...
      ExpressionAttributeValues: {
        ...
        // ":Region": brandRequest.Region,
        ":UpdatedAt": brandRequest.UpdatedAt,
      },
      UpdateExpression:
        "SET #PAN = :PAN, #RegBusinessName = :RegBusinessName, #PANOwnerName = :PANOwnerName, #BillingName = :BillingName, Address.Street = :Street, Address.PostalCode = :PostalCode, Address.City = :City,  #UpdatedAt = :UpdatedAt",
